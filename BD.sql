...
CREATE TABLE vendas (venda_id SERIAL PRIMARY KEY, cliente_id INT NOT NULL, produto VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, data DATE NOT NULL, FOREIGN KEY (cliente_id) REFERENCES clientes(cliente_id));
